...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.golanpiyush.yt_flutter_musicapi.YtFlutterMusicapiPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin yt_flutter_musicapi, com.golanpiyush.yt_flutter_musicapi.YtFlutterMusicapiPlugin", e);
    }
  }
}
